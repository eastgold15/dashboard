...
<template>
  <div class="h-90% w-85% table">
    <el-table :data="tableData" style="width: 100%" highlight-current-row :stripe="true" :border="true" height="240">
      ...
      <el-table-column prop="normMount" label="定额" align="center" />
